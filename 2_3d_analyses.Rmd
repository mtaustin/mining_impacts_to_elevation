...
```{r}
srtm_slope <- terrain(mines[[2]],opt='slope',units='degrees')
plot(srtm_slope)
```
...
```{r}
slope_pre <- terrain(mines[[1]], opt='slope',units='degrees')
plot(slope_pre)

slope_post <- terrain(mines[[2]], opt='slope', units='degrees')
plot(slope_post)

slope_dod <- terrain(mines[[3]], opt='slope', units='degrees')
plot(slope_dod)
```
...
pre_matrix <- matrix(raster::extract(mines[[1]],
                     raster::extent(mines[[1]]), buffer=500),
...
post_matrix <- matrix(raster::extract(mines[[2]],
                     raster::extent(mines[[2]]), buffer=500),
